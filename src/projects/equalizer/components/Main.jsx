...
function Main() {
  return (
    <>
      <section className="bg-black w-[85vw] mx-auto my-24 h-telephone rounded-2xl flex justify-between mobile:relative mobile:flex-col mobile:my-0 mobile:w-full mobile:min-h-screen">

      <div className='w-[20vw] md:w-[150vw]' ></div>


        <div className='min-w-[20rem] h-telephone -mt-44 z-10 mobile:-mt-16 md:absolute md:ml-4 mobile:static mobile:flex mobile:align-middle mobile:justify-center mobile:h-[30rem] mobile:min-w-[80vw] mobile:m-auto'>
          <img src={telephone} alt="telephone" className="max-w-full max-h-full mobile:max-w-[80%] mobile:contain" />
        </div>

        <div className='md:w-[200vw] mobile:w-[0]' ></div>

        <div className=' w-[23rem] mobile:w-[80%] mobile:left-8 mobile:m-auto '>
            <img src={pattern} alt="pattern" className='absolute max-w-full max-h-full mobile:max-w-[80%] mobile:contain mobile:top-0' />
        </div>

        <div className='bg-[#FA7453] w-[27rem] rounded-2xl z-10 mt-44 -mb-40 mobile:-mb-0 mobile:w-screen '>
